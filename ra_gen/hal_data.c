...
#endif
     .compare_match_value = { /* CMP_A */ (uint32_t)0x100000000, /* CMP_B */ (uint32_t)0x0}, .compare_match_status = (0U << 1U) | 1U,
...
sci_uart_instance_ctrl_t     g_uart0_ctrl;
            ...
            const uart_cfg_t g_uart0_cfg =
            {
                ...
                .p_callback          = target_uart_handler,
                .p_context           = NULL,
