 ...
 *
 *  EK-RA6M5（Cortex-M33）は DWT を実装するので，USE_ARM_DWT_PMCNT 定義時は
 ...
 *  コアクロック＝CPU_CLOCK_HZ で計数．fsp.h が CPU_CLOCK_HZ を定義）．
